...
@section('title', 'Blog | RuangKonsul')
	...
	<div class="col-lg-12 mb-5">
		<div class="single-blog-item">
			...
			<div class="blog-item-content mt-5">
				...
				<h2 class="mb-4 text-md"><a href="blog-single.html">Menjaga Kesehatan Tubuh dan Mental secara Menyeluruh</a></h2>

				<p class="lead mb-4">"Mens sana in corpore sano."</p>
