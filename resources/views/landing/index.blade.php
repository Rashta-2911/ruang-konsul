		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi1') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi2') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi3') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi4') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi5') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="service-item mb-4">
			...
			<div class="content">
				<p class="mb-4">
					...
					<a href="{{ url('/jelajahi6') }}">Jelajahi</a>
				</p>
			</div>
		</div>
	</div>
...
<section class="section appoinment">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('images/about/Foto dokter.jpeg') }}"
                     class="img-fluid"
                     alt="Dokter RuangKonsul">
            </div>
